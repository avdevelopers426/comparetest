...
export default {
  ...
  methods: {
    ...
    getPlaceholders(placeholder) {
      ...
      return this.notification.name.includes('rescheduled') ? this.allPlaceholderTypes[placeholder.type] : this.allPlaceholderTypes[placeholder.type].filter(p => !p.value.includes('initial'))
    }
  }
